...
const Footer = () => {
  return (
    <section className="relative w-full max-h-[50dvh] max-w-screen-2xl md:mt-20 mt-5 h-auto flex items-center gap-3 md:gap-5 justify-center py-5 md:py-10 flex-col overflow-hidden">
