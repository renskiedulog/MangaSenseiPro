...
const Footer = () => {
  return (
    <section className="relative max-h-[50dvh] md:mt-5 mt-2 h-auto flex items-center gap-3 md:gap-5 justify-center py-5 md:py-10 flex-col w-full overflow-hidden">
